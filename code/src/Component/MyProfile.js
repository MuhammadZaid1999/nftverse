...
function MyProfile() {
    ...
    //     if(JSON.stringify(user_data) !== '{}'){
    //         if(user_data.nfts.length > 0){
    //             const filteredData = user_data.nfts.filter(obj => (obj.network === networkId));
    //             set_user_nfts(filteredData);
    //         }
    //     }
    // }
                                            ...
                                            <div className="col-sm-3">
                                                <div className="my-assets-field row mt-5">
                                                    ...
                                                    <div className="row pt-2 pl-2">
                                                        ...
                                                        <div className="intro-button col-sm"><button className="btn btn-sm"><a className="nav-link" href="/ViewDetails">Expand Item</a></button></div>
                                                    </div>
                                                </div>
                                            </div>
